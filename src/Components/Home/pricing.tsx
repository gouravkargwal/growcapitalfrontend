    ...
    return (
        <div className="bg-black text-white min-h-screen flex justify-center items-center">
            <div className="w-full max-w-6xl px-4">
                <h1 className="text-4xl font-bold text-center mb-10">Simple and Flexible Pricing</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Personal Plan */}
                    <motion.div
                        className={`bg-gray-800 hover:bg-white hover:text-black transition-all duration-300 rounded-lg p-6 ${highlighted === 'personal' ? 'scale-105 bg-white text-black' : ''
                            }`}
                    ...
                    >
                        ...
                        <p className="text-2xl font-bold mb-4">
                            {isMonthly ? '$29' : '$290'} <span className="text-sm">per month</span>
                        </p>
                        <p className="text-gray-400 hover:text-gray-800 mb-4 transition duration-300">
                        ...
                        <button className="mt-6 bg-black hover:bg-gray-800 text-white hover:text-white py-2 px-4 rounded-lg w-full transition duration-300">
                            Get Started
                        </button>
                    </motion.div>
                    ...
                    <motion.div
                        className={`bg-gray-800 hover:bg-white hover:text-black transition-all duration-300 rounded-lg p-6 ${highlighted === 'pro' ? 'scale-105 bg-white text-black' : ''
                            }`}
                        variants={pricingvarient}
                        initial="initial"
                    ...
                    >
                        ...
                        <p className="text-2xl font-bold mb-4">
                            {isMonthly ? '$39' : '$390'} <span className="text-sm">per month</span>
                        </p>
                        <p className="text-gray-400 hover:text-gray-800 mb-4 transition duration-300">
                            For growing teams that need to track their projects and hit deadlines
                        </p>
                        <ul className="space-y-2">
                    ...
                    {/* Custom Plan */}
                    <motion.div
                        className={`bg-gray-800 hover:bg-white hover:text-black transition-all duration-300 rounded-lg p-6 ${highlighted === 'custom' ? 'scale-105 bg-white text-black' : ''
                            }`}
                        variants={pricingvarient}
                        initial="initial"
